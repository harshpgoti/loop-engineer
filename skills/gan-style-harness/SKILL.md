...
description: "Generator-evaluator agent harness for building high-quality applications autonomously. Use when a feature should be built autonomously through generator and evaluator iteration until it clears a quality bar."
metadata:
  origin: Loop Engineer-community
...
> Generator-evaluator harness pattern: a producer crafts an output, an evaluator scores it, and the loop continues until the output clears the bar.
...
The harness should simplify as models improve. As models improve,
...
- See "Related skills" below for adjacent harnesses in the Loop Engineer chain.
