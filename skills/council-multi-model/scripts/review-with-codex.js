...
function runReview(prompt, options, dependencies = {}) {
  ...
  if (!options.consent) throw new Error('External provider transfer consent is required');
  ...
  const tempDir = makeTemp(path.join(os.tmpdir(), 'loop-engineer-council-review-'));
