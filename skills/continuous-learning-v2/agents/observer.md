...
A background agent that analyzes observations from agent harness sessions to detect patterns and create instincts.
...
- Project: `${XDG_DATA_HOME:-~/.local/share}/loop-engineer-instinct-store/projects/<project-hash>/observations.jsonl`
- Global fallback: `${XDG_DATA_HOME:-~/.local/share}/loop-engineer-instinct-store/observations.jsonl`
...
- Project: `${XDG_DATA_HOME:-~/.local/share}/loop-engineer-instinct-store/projects/<project-hash>/instincts/personal/`
- Global: `${XDG_DATA_HOME:-~/.local/share}/loop-engineer-instinct-store/instincts/personal/` (for universal patterns)
