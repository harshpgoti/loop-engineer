...
**Related Skills**: `scroll-animation`, `ui-motion`, `lottie-animations` for optimized animations
...
**Related Skills**: `ui-motion`, `react-spring-physics`, `animejs` for micro-interactions
...
**Related Skills**: `scroll-animation`, `locomotive-scroll`, `scroll-reveal-libraries`, `react-3d` for 3D scrollytelling
...
**Related Skills**: `scroll-animation` (for easing), `ui-motion` (for React cursor components)
...
- Text animation: GSAP SplitText with stagger (`scroll-animation`)
- Button: Framer Motion hover states (`ui-motion`)
- Scroll indicator: CSS animation + GSAP fade out on scroll

**Related Skills**: `lightweight-3d-effects`, `scroll-animation`, `ui-motion`
...
**Related Skills**: `react-3d`, `webgl-3d`, `model-viewer-component`
...
**Related Skills**: `ui-motion`, `pixijs-2d` for canvas-based visualizations
...
**Related Skills**: `barba-js`, `scroll-animation`, `ui-motion`
...
**Related Skills**: `scroll-animation`, `ui-motion`
...
**Related Skills**: `ui-motion`, `scroll-animation`, `scroll-reveal-libraries`
...
**Related Skills**: `webgl-3d`, `react-3d`, `babylonjs-engine`
...
- `scroll-animation` - Scroll-driven animations, pinning, scrubbing
- `ui-motion` - React animations, gestures, layout animations
...
### 3D & WebGL
- `webgl-3d` - Custom 3D scenes and effects
- `react-3d` - 3D in React applications
...
In this folder:
- `design-patterns.md` - Design trends and the micro-interaction catalog
- `quality-checklists.md` - WCAG accessibility patterns and performance optimization

### Scripts

- `../scripts/pattern_generator.py` - Generate design pattern boilerplate
- `../scripts/design_audit.py` - Audit existing designs for compliance
