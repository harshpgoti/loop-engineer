...
- **Setup**: configure Motion imports and prepare the component structure
...
│   → Example: ../examples/motion-patterns.md (Hero Fade Up)
│
...
│   → Examples: ../examples/motion-patterns.md (Card Hover, Magnetic Button)
│
...
│   → Examples: ../examples/motion-patterns.md (Scroll Reveal, Parallax Layers)
│
...
**Full API**: See [Complete API Reference](motion-reference.md)
...
### Hero Sections
- [Hero Fade Up](../examples/motion-patterns.md) - Classic Apple-style entrance
- Hero Stagger - Orchestrated elements
- Hero Split Text - Character reveal

### Scroll Effects
- [Scroll Reveal](../examples/motion-patterns.md) - Intersection Observer fade-in
- [Parallax Layers](../examples/motion-patterns.md) - Multi-speed depth
- Scroll Progress - Reading indicator

### Gestures & Interactions
- [Card Hover](../examples/motion-patterns.md) - Elegant lift + shadow
- [Magnetic Button](../examples/motion-patterns.md) - Cursor-following
...
**Full examples**: `../examples/motion-patterns.md`

## Reference Documentation (Load On-Demand)

- [Complete API Reference](motion-reference.md) - All components, hooks, props
- [Spring Physics Guide](motion-reference.md) - Tuning stiffness, damping, mass
...
**More patterns**: Staggered lists, exit animations, layout transitions → `../examples/motion-patterns.md`
