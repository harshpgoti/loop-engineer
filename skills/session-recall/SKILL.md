---
name: session-recall
description: Recalls relevant past loop sessions from state.db into plan/SESSION_RECALL.md at session start. Use when the user types /session-recall or at the start of /plan-loop, /develop-product, or /loop-engine.
---
