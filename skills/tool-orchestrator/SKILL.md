...
| Spec-driven task discipline | Phased development from idea to build tasks — see `plan/features/`, `skills/task-compiler/SKILL.md` |
...
| Role-based review | Strategy, PM, design, engineering, QA, security, release perspectives — see `skills/product-council/SKILL.md` |
