---
name: eval-harness
description: Formal evaluation framework for agent harness sessions implementing eval-driven development (EDD) principles. Use when a agent harness workflow needs a formal eval before it is trusted or changed.
metadata:
...
A formal evaluation framework for agent harness sessions, implementing eval-driven development (EDD) principles.

## When to Activate

- Setting up eval-driven development (EDD) for AI-assisted workflows
- Defining pass/fail criteria for agent harness task completion
