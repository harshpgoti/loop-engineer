...
- Review this file at the start of `/plan`, `/product-develop`, and `/loop-engine`.
...
- **Status:** open
- **Question:** What product should this loop plan and build?
...
- **Why it matters:** `/plan` should create `plan/step_01_<slug>.md`.
