...
<What this skill lets the agent do, in one or two sentences.>
...
<Non-obvious constraints: rate limits, data it must never touch, formats it must follow, permission scope.>

## Example

<A minimal worked example of the skill being invoked and what it returns.>
